...
#execute() 메소드의 두 번째 매개변수에는 파라미터를 지정할 수 있습니다.
...
#executemany() 메소드를 사용하면 여러 개의 파라미터를 리스트로 지정해서
#여러 개(현재 예제에서는 3개)의 SQL 구문을 실행 할 수 있습니다.
...
#쿼리의 결과는 fetchall() 메소드로 추출할 수 있습니다.
